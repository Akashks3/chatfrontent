...
const UserSearch = () => {
	...
	return (
		<>
			<div className="p-6 w-full h-[7vh] font-semibold flex justify-between items-center text-white border-slate-500 border-r">
				...
				<div className="w-2/3 flex flex-nowrap items-center gap-2">
					<input
						...
						className="w-full  py-1 px-2 font-normal outline-none rounded-md cursor-pointer bg-transparent active:bg-black/20"
					...
					<>
						...
						{selectedUsers?.map((user) => {
							return (
								<div
									key={user?._id}
									className="w-full h-16  border rounded-lg flex justify-start items-center p-2 font-semibold gap-2 hover:bg-black/50 transition-all cursor-pointer text-white"
