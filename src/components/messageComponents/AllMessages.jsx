...
const AllMessages = ({ allMessage }) => {
    ...
    return (
        <>
            {scrollShow && (
                <div
                    className="absolute bottom-16 right-4 cursor-pointer z-20 font-light text-white/50 bg-white/50 hover:bg-white hover:text-white p-1.5 rounded"
                        ...
                        <Fragment key={message._id}>
                            <div className="sticky top-0 flex w-full justify-center z-10">
                                {new Date(
                                    ...
                                    <span className="text-xs font-light mb-2 mt-1 text-white bg-white/50 h-7 w-fit px-5 rounded-md flex items-center justify-center cursor-pointer">
                            ...
                            >
                                ...
                                <div
                                    className={`${
                                        message?.sender?._id === adminId
                                            ? "bg-white  text-black rounded-s-lg rounded-ee-2xl"
                                            : "bg-white text-black rounded-e-lg rounded-es-2xl"
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span
                                            className="text-[11px] font-light text-black absolute bottom-1 right-2 flex items-end gap-1.5"
